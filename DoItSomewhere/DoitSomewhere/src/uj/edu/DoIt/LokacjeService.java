...
public class LokacjeService extends Service {
	...
	public void onCreate() {
		...
		mgr.requestLocationUpdates(LocationManager.GPS_PROVIDER,10000, 10000.0f, onLocationChange);
	}
	...
	public class LocalBinder extends Binder {
		LokacjeService getService() {
			return(LokacjeService.this);
		}
	}
